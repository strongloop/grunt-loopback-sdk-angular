...
Thank you for your interest in `grunt-loopback-sdk-angular`, an open source project
administered by StrongLoop.

Contributing to `grunt-loopback-sdk-angular` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/grunt-loopback-sdk-angular)
